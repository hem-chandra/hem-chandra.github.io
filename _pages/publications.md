...
<h2 style="text-align: left; font-size: 24px; color: #333; margin-bottom: 0px;">
 ...
 <!-- Thumbnail Image -->
 <img src="https://raw.githubusercontent.com/hem-chandra/hem-chandra.github.io/master/images/Famps_overview.jpeg" 
     alt="Learning About People’s Attitude Towards Food Available" 
     style="width: 50%; height: auto; float: left; margin-right: 5px; border: 2px solid #ccc; padding: 15px; border-radius: 1px;">
